    ...
    manifest = {
        ...
        **details,
        ...
        "verify_commands": [
            ...
            "./.venv/bin/python scripts/phase1_matrix.py http://<staging-host>",
            "./.venv/bin/python scripts/phase2_upload_smoke.py http://<staging-host>",
            "./.venv/bin/python scripts/phase3_ui_contract_smoke.py http://<staging-host>",
        ],
    }
    return manifest
