...
- Implemented Trevor's requested UI fixes: changed visible `Generator` to `Machine`, made `Machine` use the same purple/pink gradient family as the button, added a Light/Dark header switch, and added all seven FAQ concepts from the reference page.
